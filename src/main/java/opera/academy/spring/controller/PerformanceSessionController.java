...
import opera.academy.spring.service.PerformanceSessionService;
import opera.academy.spring.service.mapper.PerformanceSessionMapper;
...
public class PerformanceSessionController {
    ...
    @PostMapping
    public PerformanceSessionResponseDto add(@RequestBody @Valid PerformanceSessionRequestDto requestDto) {
